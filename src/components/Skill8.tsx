...
function Skill8({directionLeft}: Props) {   //1 change for skill
  return (
    <div className='group relative flex cursor-pointer'>
        <motion.img initial={{
          ...
          src={vs.src}  // there is an error of importing image which have been solved by using .src
          alt='git'
...
export default Skill8  // 2 change for skill