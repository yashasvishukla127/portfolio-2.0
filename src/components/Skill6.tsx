...
function Skill6({directionLeft}: Props) {   //1 change for skill
  return (
    <div className='group relative flex cursor-pointer'>
        <motion.img initial={{
          ...
          src={next.src}  // there is an error of importing image which have been solved by using .src
          alt='git'
...
export default Skill6  // 2 change for skill