...
function Skill5({directionLeft}: Props) {   //1 change for skill
  return (
    <div className='group relative flex cursor-pointer'>
        <motion.img initial={{
          ...
          src={javascript.src}  // there is an error of importing image which have been solved by using .src
          alt='git'
...
export default Skill5 // 2 change for skill